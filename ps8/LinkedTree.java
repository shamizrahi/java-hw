...
public class LinkedTree {
     ...
     * from PS 7, Problem 4
     */
    public int depthOriginal(int key) {
    ...
    private static int numSmallerInTree(Node root, int t) {
        ...
        if (root.left != null && t > root.key) {
            count += numSmallerInTree(root.left, t);
        }
        if (root.right != null && t > root.key) {
     ...
     * only parameter; uses recursion to find 
     * and return the number of even-valued keys in the 
     * binary search tree or subtree whose root node is 
    ...
    private static int countEvensInTree(Node root){
        ...
        if (root == null) {    // root is the root of the entire tree
            ...
            if(root.key % 2 == 0){ //checking for even
               retVar += 1 + countEvensInTree(root.left) +  countEvensInTree(root.right); //add one and recurive call

            }else{
                retVar += countEvensInTree(root.left) +  countEvensInTree(root.right); //continue recursion
            }
        }
    ...
    */
    ...
    public int countEvens(){
        ...
        int countEven = countEvensInTree(root);
        return countEven;

    }

     /*
    * method that determine and return the depth of the node with that key.
    */
    ...
    public int depth(int k){
        ...
        if(trav == null){ //empty tree
            return -1;
        }
       
        while( trav != null ){ 
            
            if (trav.key == k){ //if the key is found return depth
                return depth;
                    
            }else if(trav.key > k){ // if key less than trav.key go left 
                trav = trav.left;
                depth++;

            }else if (trav.key < k){ // if key grater than trav.key go right 
                trav = trav.right;
                depth++;
    ...
    /*
    * Uses iteration to find and delete the node containing the largest key in the tree
    */
    ...
    public int deleteMax(){
        ...
        Node trav = root; // start point root
        Node prev = null; //previous key
        int max = trav.key; //max key

        //finding max key
        while(trav.right != null){
            int k = trav.key; //variable to compare
        ...
        //deleting and handling parent and child
        if(trav.left == null){
            prev.right = null;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int results = tree.depthOriginal(28);
        ...
        System.out.println("(1) Testing on tree from Problem 2, numSmaller()/numSmallerInTree()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {5, 14, 26, 49, 37, 42, 9, 17, 85};
            tree.insertKeys(keys);
            
            int results = tree.numSmaller(30);
            int expected = 5;
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
        ...
        /*
         * Tests for countEvensInTree() and countEvens()
         */

        System.out.println("(2) Testing on tree from Problem 2, countEvensInTree()/countEvens()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {3, 8, 26, 60, 43, 52, 97, 31, 73};
            tree.insertKeys(keys);
        ...
        System.out.println("(3) Testing on tree from Problem 2, countEvensInTree()/countEvens()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {6, 4, 10, 16, 22, 42, 92, 18, 82};
            tree.insertKeys(keys);
        ...
        System.out.println("(4) Testing on tree from Problem 2, countEvensInTree()/countEvens()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {3, 8, 26, 60, 43, 52, 97, 31, 73};
            tree.insertKeys(keys);
            
            int results = tree.depth(97);
            int expected = 4;
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
        ...
        System.out.println("(5) Testing on tree from Problem 2, countEvensInTree()/countEvens()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {6, 4, 10, 16, 22, 42, 92, 18, 82};
            tree.insertKeys(keys);
            
            int results = tree.depth(22);
            int expected = 3;
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
        ...
        System.out.println("(6) Testing on tree from Problem 3, deleteMax()");
        try {
            LinkedTree tree = new LinkedTree();
        ...
        System.out.println("(7) Testing on tree from Problem 3, deleteMax()");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {6, 4, 10, 16, 22, 42, 92, 18, 82};
            tree.insertKeys(keys);
